(() => {
  ...
  document.querySelectorAll(".svc-card,.rev-card,.pol-card").forEach((card) => {
    card.addEventListener("mousemove", (e) => {
      ...
      card.style.transform = `perspective(900px) rotateX(${-y * 6}deg) rotateY(${x * 6}deg) translateY(-6px) scale(1.015)`;
    });
  ...
  document
    .querySelectorAll(".btn-primary,.btn-submit,.btn-nav")
    .forEach((btn) => {
